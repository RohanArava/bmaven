...
const { addCollection, removeCollection, searchServicebyTerm, searchServiceDefault, getService, writeReview, addToCollection, getCollection, buyService, reportService} = require("../controllers/user_util.controller")
...
router.post("/reportService", reportService)
