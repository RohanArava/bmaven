...
export default function Search() {
    ...
    const { loading, error, data } = useFetch(query_term&&query_term!==''?`http://localhost:8085/userutil/search?q=${query_term}`:"http://localhost:8085/userutil/search/default", [query_term])
